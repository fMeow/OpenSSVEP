...
#define ADS1292_SPI hspi1
/****************************************Control Pin 2 Low******************************************************/
#define ADS1292_CS_L            HAL_GPIO_WritePin(ADS1292_CS_GPIO_Port    , ADS1292_CS_PIN    ,   GPIO_PIN_RESET)
#define ADS1292_SCK_L           HAL_GPIO_WritePin(ADS1292_SCK_GPIO_Port   , ADS1292_SCK_PIN   ,   GPIO_PIN_RESET)
#define ADS1292_CLKSEL_L        HAL_GPIO_WritePin(ADS1292_CLKSEL_GPIO_Port, ADS1292_CLKSEL_PIN,   GPIO_PIN_RESET)
#define ADS1292_START_L         HAL_GPIO_WritePin(ADS1292_START_GPIO_Port , ADS1292_START_PIN ,   GPIO_PIN_RESET)
#define ADS1292_RESET_L         HAL_GPIO_WritePin(ADS_1292_RESET_GPIO_Port, ADS_1292_RESET_PIN,   GPIO_PIN_RESET)
#define ADS1292_DIN_L           HAL_GPIO_WritePin(ADS1292_IN_GPIO_Port    , ADS1292_IN_PIN    ,   GPIO_PIN_RESET)
/****************************************Control Pin 2 High*****************************************************/
#define ADS1292_CS_H            HAL_GPIO_WritePin(ADS1292_CS_GPIO_Port    , ADS1292_CS_PIN    ,   GPIO_PIN_SET)
#define ADS1292_SCK_H           HAL_GPIO_WritePin(ADS1292_SCK_GPIO_Port   , ADS1292_SCK_PIN   ,   GPIO_PIN_SET)
#define ADS1292_CLKSEL_H        HAL_GPIO_WritePin(ADS1292_CLKSEL_GPIO_Port, ADS1292_CLKSEL_PIN,   GPIO_PIN_SET)
#define ADS1292_START_H         HAL_GPIO_WritePin(ADS1292_START_GPIO_Port , ADS1292_START_PIN ,   GPIO_PIN_SET)
#define ADS1292_RESET_H         HAL_GPIO_WritePin(ADS_1292_RESET_GPIO_Port, ADS_1292_RESET_PIN,   GPIO_PIN_SET)
 /****************************************************************/
...
extern uint8_t   ADS_TEST;  
extern uint8_t   LOFF_STA;
extern uint8_t   ADS_GPIO;
extern  long  ADS_CH1 ; 
extern  long  ADS_CH2 ;
extern uint8_t ADS1292_Data[16];
extern uint8_t ADS1292_Default_Register_Settings[16];
